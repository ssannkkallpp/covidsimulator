 ...
 */
!(function (f, e) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e(require('chart.js')) : typeof define === 'function' && define.amd ? define(['chart.js'], e) : (f = f || self).ChartColorSchemes = e(f.Chart); }(this, (f) => {
  f = f && f.hasOwnProperty('default') ? f.default : f; const e = Object.freeze({
  ...
  }; const c = f.helpers; const a = f.DatasetController.prototype.removeHoverStyle.length === 2; const b = '$colorschemes'; f.defaults.global.plugins.colorschemes = {
    scheme: 'brewer.Paired12', fillAlpha: 0.5, reverse: !1, override: !1,
  }; const r = {
    id: 'colorschemes', beforeUpdate(e, d) { let a; let r; let l; let o; let n; let t = (function (e) { let d; let a; let b; let r; return c.isArray(e) ? e : typeof e === 'string' && (d = f.colorschemes || {}, (a = e.match(/^(brewer\.\w+)([1-3])-(\d+)$/)) ? e = a[1] + ['One', 'Two', 'Three'][a[2] - 1] + a[3] : e === 'office.Office2007-2010-6' && (e = 'office.OfficeClassic6'), r = d[(b = e.split('.'))[0]]) ? r[b[1]] : void 0; }(d.scheme)); const u = d.fillAlpha; const i = d.reverse; const s = d.override; const B = d.custom; t && (typeof B === 'function' && (r = B(a = t.slice()), c.isArray(r) && r.length ? t = r : c.isArray(a) && a.length && (t = a)), l = t.length, e.config.data.datasets.forEach((f, d) => { switch (o = d % l, n = t[i ? l - o - 1 : o], f[b] = {}, f.type || e.config.type) { case 'line': case 'radar': case 'scatter': (void 0 === f.backgroundColor || s) && (f[b].backgroundColor = f.backgroundColor, f.backgroundColor = c.color(n).alpha(u).rgbString()), (void 0 === f.borderColor || s) && (f[b].borderColor = f.borderColor, f.borderColor = n), (void 0 === f.pointBackgroundColor || s) && (f[b].pointBackgroundColor = f.pointBackgroundColor, f.pointBackgroundColor = c.color(n).alpha(u).rgbString()), (void 0 === f.pointBorderColor || s) && (f[b].pointBorderColor = f.pointBorderColor, f.pointBorderColor = n); break; case 'doughnut': case 'pie': case 'polarArea': (void 0 === f.backgroundColor || s) && (f[b].backgroundColor = f.backgroundColor, f.backgroundColor = f.data.map((f, e) => (o = e % l, t[i ? l - o - 1 : o]))); break; default: (void 0 === f.backgroundColor || s) && (f[b].backgroundColor = f.backgroundColor, f.backgroundColor = n); } })); }, afterUpdate(f) { f.config.data.datasets.forEach((f) => { f[b] && (f[b].hasOwnProperty('backgroundColor') && (f.backgroundColor = f[b].backgroundColor), f[b].hasOwnProperty('borderColor') && (f.borderColor = f[b].borderColor), f[b].hasOwnProperty('pointBackgroundColor') && (f.pointBackgroundColor = f[b].pointBackgroundColor), f[b].hasOwnProperty('pointBorderColor') && (f.pointBorderColor = f[b].pointBorderColor), delete f[b]); }); }, beforeEvent(f, e, d) { a && this.beforeUpdate(f, d); }, afterEvent(f) { a && this.afterUpdate(f); },
  }; return f.plugins.register(r), f.colorschemes = d, r;
}));
